        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card" style="border-radius: 10px">
                    <div class="rounded-5 w-100 p-500" style="padding: 20px; font-size: 20px; color: black;">AMICTA x Skyshi Fun Coding Competition</div>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card h-100 d-flex justify-content-between" style="padding: 25px;">
                    <div>
                        <h4 class="text-center p-600 mb-2" style="color: black; font-size: 16px">AMICTA x Skyshi Fun Coding Competition</h4>
                        <br>
                        <ul>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <a target="_blank" href="https://devcode.gethired.id/challenge/fe-getjadwal-amicta" class="w-100 btn mt-2 button-base text-white">Join Front-End Programming</a>
                            </div>
                            <div class="col-md-6">
                                <a target="_blank" href="https://devcode.gethired.id/challenge/be-getjadwal-amicta" class="w-100 btn mt-2 button-base text-white">Join Back-End Programming</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <a target="_blank" href="https://chat.whatsapp.com/GS81zNkEgkTCSnUknXaFuC" class="w-100 btn mt-2 btn-warning text-white">Join Grup WhatsApp</a>
                            </div>
                        </div>
                        <p></p>
                    </div>
