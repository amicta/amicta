...
<body>
    ...
    <section>
        <div
            ...
            <div class="text-white">
                <h1 class="font-bold text-sm sm:text-[20px] lg:text-[40px] lg:leading-[46px] p-700">CELEBRATION DAY
                    AMICTA 2022</h1>
                <p class="mt-3 text-xs lg:text-sm">Hadirlah pada puncak kegiatan AMICTA 2022 di CELEBRATION DAY.</p>
            ...
            <div class="w-56 sm:w-[300px] lg:w-[500px] justify-self-center mb-2 z-50"><img
                    src="{{ asset('assets/img/achievement.svg') }}" alt=""></div>
        </div>
            ...
            @forelse ($data['events'] as $event)
                <div class="px-[8px] sm:px-[50px] lg:px-[100px]">
                    ...
                    @if ($event->is_available)
                        <form class="text-left" action="{{ route('celebration.register') }}" method="POST">
                            @csrf
                            ...
                            <div class="text-sm sm:text-base inline-block mb-2 p-700">
                                Tau informasi celebration day dari mana ?
                            </div>
    ...
    <!-- footer -->
    <section>
        <footer class="text-center p-700 text-gray-500 p-7 sm:p-14">
            ...
            <div class="text-xs text-white lg:text-sm">Contact Person : 081235493328</div>
            <div class="text-xs text-white lg:text-sm">© 2022 AMICTA. Organized by AMCC</div>
        </footer>
    </section>
