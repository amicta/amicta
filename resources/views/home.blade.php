            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="list-group">
                                <li class="gap-1 list-group-item d-flex justify-content-between align-items-center flex-col">
                                    <div>Tahap 2 : Pengumpulan Pitch Deck & Video</div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="list-group">
                                <li class="gap-1 list-group-item d-flex justify-content-between align-items-center flex-col">
                                    <div>Tahap 1 : Upload Submisi dan Menambahkan Tim</div>
                                    <div class="badge-yellow">Menunggu Respon</div>
                                </li>
                            </ul>    
                        </div>
